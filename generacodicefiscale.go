...
// Generazione codice fiscale 2019-2023 - Squeeze69

//go:generate go run genera/scaricacomuni/scaricacomuni.go

//go:generate go fmt comuni.go

//go:generate go run genera/scaricanazioni/scaricanazioni.go
